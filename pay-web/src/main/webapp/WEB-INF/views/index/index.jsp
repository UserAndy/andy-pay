<%--
  ...
  User: andy   http://localhost:8080/pay/user/index
  Date: 16-11-26
  Time: 上午12:50
...
<head>
    ...
    <!-- Morris -->
    <link href="<%=basePath%>resources/common/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <!-- Gritter -->
    <link href="<%=basePath%>resources/common/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<script>
    function showhide(){
        var bodyObj = $("body");
        if(bodyObj.hasClass("mini-navbar")){
            bodyObj.removeClass("mini-navbar");
        }else{
            bodyObj.addClass("mini-navbar");
        }
    }
</script>
<body class="pace-done ">
<div id="wrapper">
    <jsp:include page="nav_index.jsp"/>
  ...
  <%--          <div class="row">
        ...
        <!--nav bottom-->
        <jsp:include page="nav_bottom.jsp"/>
    </div>
</div>
...
<!-- Flot -->
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/flot/jquery.flot.symbol.js"></script>
...
<!-- jQuery UI -->
<script src="<%=basePath%>resources/common/js/plugins/jquery-ui/jquery-ui.min.js"></script>

<!-- Jvectormap -->
<script src="<%=basePath%>resources/common/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<%=basePath%>resources/common/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- EayPIE -->
<script src="<%=basePath%>resources/common/js/plugins/easypiechart/jquery.easypiechart.js"></script>

<!-- Sparkline -->
<script src="<%=basePath%>resources/common/js/plugins/sparkline/jquery.sparkline.min.js"></script>

<!-- Sparkline demo data  -->
<script src="<%=basePath%>resources/common/js/demo/sparkline-demo.js"></script>
