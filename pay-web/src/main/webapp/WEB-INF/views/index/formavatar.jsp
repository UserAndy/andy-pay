                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>/resources/common/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="<%=basePath%>/resources/common/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="m-t m-b">
                                ...
                                <div id="userAlbums" style="display:none">
                                    <a href="<%=basePath%>/resources/common/img/a1.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a1.jpg" alt="示例图片1" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a2.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a2.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a3.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a3.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a4.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a4.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a5.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a5.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a6.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a6.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a7.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a7.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a8.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a8.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="<%=basePath%>/resources/common/img/a9.jpg" class="fancybox" title="选取该照片">
                                        <img src="<%=basePath%>/resources/common/img/a9.jpg" alt="示例图片2" />
                                    </a>>
                                </div>
                            </div>
...
<!-- fullavatareditor -->
<script type="text/javascript" src="<%=basePath%>/resources/common/plugins/fullavatareditor/scripts/swfobject.js"></script>
<script type="text/javascript" src="<%=basePath%>/resources/common/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
<script type="text/javascript" src="<%=basePath%>/resources/common/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
<script type="text/javascript" src="<%=basePath%>/resources/common/plugins/fullavatareditor/scripts/test.js"></script>
</body>
</html>
