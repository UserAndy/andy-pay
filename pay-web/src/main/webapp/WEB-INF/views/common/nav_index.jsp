    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <span><img alt="image" class="img-circle" src="<%=basePath%>resources/common/img/profile_small.jpg" /></span>
       ...
       <%--     <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li><a class="J_menuItem" href="<%=basePath%>/user/list">用户列表</a></li>
                    <li><a class="J_menuItem" href="<%=basePath%>/user/locklist">已锁定用户列表</a></li>
                </ul>
            </li>
            <li>
